...
#------------------------------------------------------------------------#
# Shell-id     : supbd1003
# Shell-名     : supbd1003.csh
# 機能         : メニューサービス区分更新処理（新聞競馬新聞実績バッチ開始）
#                wtzzom001.sql
#                  PARM1:メニュー単位
#                  PARM2:サービス区分
#                        '00':サービス中
...
#------------------------------------------------------------------------#
#E10K BEF#set SQL_PARM=(-s $ORAUID/$ORAPWD @$SQLDIR/wtzzom001.sql 'XY_XYKJ0210' '02')
set SQL_PARM=(-s $ORAUID/$ORAPWD @${PLSQLDIR}/wtzzom001.sql 'XY_XYKJ0210' '02')
#
...
#------------------------------------------------------------------------#
#E10K BEF#set SQL_PARM=(-s $ORAUID/$ORAPWD @$SQLDIR/wtzzom001.sql 'XY_XYKJ0220' '02')
set SQL_PARM=(-s $ORAUID/$ORAPWD @${PLSQLDIR}/wtzzom001.sql 'XY_XYKJ0220' '02')
#
# ORACLE TABLE SFM_メニュー単位@XXXX
#
source $SUBSRCDIR/execsql.src
...
#------------------------------------------------------------------------#
#E10K BEF#set SQL_PARM=(-s $ORAUID/$ORAPWD @$SQLDIR/wtzzom001.sql 'XY_XYKJ0230' '02')
set SQL_PARM=(-s $ORAUID/$ORAPWD @${PLSQLDIR}/wtzzom001.sql 'XY_XYKJ0230' '02')
#
# ORACLE TABLE SFM_メニュー単位@XXXX
#
source $SUBSRCDIR/execsql.src
